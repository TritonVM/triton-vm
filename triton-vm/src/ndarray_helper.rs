...
pub fn fast_zeros_column_major<FF: FiniteField>(num_rows: usize, num_columns: usize) -> Array2<FF> {
    Array1::<FF>::zeros(num_rows * num_columns)
        .into_shape((num_columns, num_rows))
        .unwrap()
        .reversed_axes()
}
