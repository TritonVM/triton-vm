...
impl ExtProgramTable {
    ...
    fn ext_terminal_constraints(
        _challenges: &ProgramTableChallenges,
        _terminals: &ProgramTableTerminals,
    ) -> Vec<MPolynomial<XFieldElement>> {
        // no further constraints
        vec![]
    }
...
impl ProgramTable {
    ...
    pub fn extend(
    ...
    ) -> (ExtProgramTable, ProgramTableTerminals) {
        ...
        let terminals = ProgramTableTerminals {
            instruction_eval_arg: instruction_table_running_evaluation,
        };
    ...
    pub fn for_verifier(
        ...
        let extension_table = base_table.extension(
            ...
            ExtProgramTable::ext_terminal_constraints(
                ...
                &all_terminals.program_table_terminals,
            ),
        );
...
#[derive(Debug, Clone)]
pub struct ProgramTableTerminals {
    /// Values randomly generated by the prover for zero-knowledge.
    pub instruction_eval_arg: XFieldElement,
}
...
impl ExtensionTable for ExtProgramTable {
    ...
    fn dynamic_terminal_constraints(
        ...
        ExtProgramTable::ext_terminal_constraints(
            ...
            &terminals.program_table_terminals,
        )
    }
}
