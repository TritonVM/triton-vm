...
impl AllChallenges {
    ...
    pub fn create_challenges(
        ...
        let processor_table_challenges = ProcessorTableChallenges {
            ...
            hash_table_hash_input_weight0: weights.pop().unwrap(),
            hash_table_hash_input_weight1: weights.pop().unwrap(),
            hash_table_hash_input_weight2: weights.pop().unwrap(),
            hash_table_hash_input_weight3: weights.pop().unwrap(),
            hash_table_hash_input_weight4: weights.pop().unwrap(),
            hash_table_hash_input_weight5: weights.pop().unwrap(),
            hash_table_hash_input_weight6: weights.pop().unwrap(),
            hash_table_hash_input_weight7: weights.pop().unwrap(),
            hash_table_hash_input_weight8: weights.pop().unwrap(),
            hash_table_hash_input_weight9: weights.pop().unwrap(),

            hash_table_hash_digest_weight0: weights.pop().unwrap(),
            hash_table_hash_digest_weight1: weights.pop().unwrap(),
            hash_table_hash_digest_weight2: weights.pop().unwrap(),
            hash_table_hash_digest_weight3: weights.pop().unwrap(),
            hash_table_hash_digest_weight4: weights.pop().unwrap(),
        ...
        let hash_table_challenges = HashTableChallenges {
            ...
            hash_input_weight0: processor_table_challenges.hash_table_hash_input_weight0,
            hash_input_weight1: processor_table_challenges.hash_table_hash_input_weight1,
            hash_input_weight2: processor_table_challenges.hash_table_hash_input_weight2,
            hash_input_weight3: processor_table_challenges.hash_table_hash_input_weight3,
            hash_input_weight4: processor_table_challenges.hash_table_hash_input_weight4,
            hash_input_weight5: processor_table_challenges.hash_table_hash_input_weight5,
            hash_input_weight6: processor_table_challenges.hash_table_hash_input_weight6,
            hash_input_weight7: processor_table_challenges.hash_table_hash_input_weight7,
            hash_input_weight8: processor_table_challenges.hash_table_hash_input_weight8,
            hash_input_weight9: processor_table_challenges.hash_table_hash_input_weight9,

            hash_digest_weight0: processor_table_challenges.hash_table_hash_digest_weight0,
            hash_digest_weight1: processor_table_challenges.hash_table_hash_digest_weight1,
            hash_digest_weight2: processor_table_challenges.hash_table_hash_digest_weight2,
            hash_digest_weight3: processor_table_challenges.hash_table_hash_digest_weight3,
            hash_digest_weight4: processor_table_challenges.hash_table_hash_digest_weight4,
