...
impl AllChallenges {
    ...
    pub fn create_challenges(mut weights: Vec<XFieldElement>) -> Self {
        let processor_table_challenges = ProcessorTableChallenges {
            ...
            unique_clock_jump_differences_indeterminate: weights.pop().unwrap(),
            all_clock_jump_differences_indeterminate: weights.pop().unwrap(),
        };
        ...
        let op_stack_table_challenges = OpStackTableChallenges {
            processor_perm_row_indeterminate: processor_table_challenges.op_stack_perm_row_weight,
