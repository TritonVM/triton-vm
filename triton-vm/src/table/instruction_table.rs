...
impl ExtInstructionTable {
    ...
    fn ext_terminal_constraints(
        ...
        _terminals: &InstructionTableTerminals,
    ) -> Vec<MPolynomial<XFieldElement>> {
...
impl InstructionTable {
    ...
    pub fn extend(
    ...
    ) -> (ExtInstructionTable, InstructionTableTerminals) {
        ...
        let terminals = InstructionTableTerminals {
            ...
            program_eval_arg: program_table_running_evaluation,
        };
    ...
    pub fn for_verifier(
        ...
        let extension_table = base_table.extension(
            ...
            ExtInstructionTable::ext_terminal_constraints(
                &all_challenges.instruction_table_challenges,
                &all_terminals.instruction_table_terminals,
            ),
        );
...
impl ExtensionTable for ExtInstructionTable {
    ...
    fn dynamic_terminal_constraints(
        ...
        ExtInstructionTable::ext_terminal_constraints(
            ...
            &terminals.instruction_table_terminals,
        )
    }
}
