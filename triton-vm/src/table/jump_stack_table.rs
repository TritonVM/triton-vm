...
impl ExtJumpStackTable {
    ...
    fn ext_terminal_constraints(
        _challenges: &JumpStackTableChallenges,
        _terminals: &JumpStackTableTerminals,
    ) -> Vec<MPolynomial<XFieldElement>> {
        vec![]
    }
}
...
impl JumpStackTable {
    ...
    ) -> (ExtJumpStackTable, JumpStackTableTerminals) {
    ...
    pub fn for_verifier(
        ...
        let extension_table = base_table.extension(
            ...
            ExtJumpStackTable::ext_terminal_constraints(
                &all_challenges.jump_stack_table_challenges,
                &all_terminals.jump_stack_table_terminals,
            ),
        );
...
#[derive(Debug, Clone)]
pub struct JumpStackTableTerminals {
...
impl ExtensionTable for ExtJumpStackTable {
    ...
    fn dynamic_terminal_constraints(
        ...
        ExtJumpStackTable::ext_terminal_constraints(
            ...
            &terminals.jump_stack_table_terminals,
        )
    }
}
