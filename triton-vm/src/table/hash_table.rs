...
impl HashTable {
    ...
    pub fn extend(
    ...
    ) -> (ExtHashTable, HashTableTerminals) {
        ...
        let terminals = HashTableTerminals {
            from_processor_eval_arg: from_processor_running_evaluation,
            to_processor_eval_arg: to_processor_running_evaluation,
        };
    ...
    pub fn for_verifier(
        ...
        let extension_table = base_table.extension(
            ...
            ExtHashTable::ext_terminal_constraints(
                ...
                &all_terminals.hash_table_terminals,
            ),
        );
...
#[derive(Debug, Clone)]
pub struct HashTableTerminals {
    /// Values randomly generated by the prover for zero-knowledge.
    pub from_processor_eval_arg: XFieldElement,
    pub to_processor_eval_arg: XFieldElement,
}
...
impl ExtensionTable for ExtHashTable {
    ...
    fn dynamic_terminal_constraints(
        ...
        ExtHashTable::ext_terminal_constraints(
            ...
            &terminals.hash_table_terminals,
        )
    }
}
