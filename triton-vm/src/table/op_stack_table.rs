...
impl ExtOpStackTable {
    ...
    fn ext_terminal_constraints(
        _challenges: &OpStackTableChallenges,
        _terminals: &OpStackTableTerminals,
    ) -> Vec<MPolynomial<XFieldElement>> {
        // no further constraints
        vec![]
    }
...
impl OpStackTable {
    ...
    ) -> (ExtOpStackTable, OpStackTableTerminals) {
    ...
    pub fn for_verifier(
        ...
        let extension_table = base_table.extension(
            ...
            ExtOpStackTable::ext_terminal_constraints(
                ...
                &all_terminals.op_stack_table_terminals,
            ),
        );
...
#[derive(Debug, Clone)]
pub struct OpStackTableTerminals {
...
impl ExtensionTable for ExtOpStackTable {
    ...
    fn dynamic_terminal_constraints(
        ...
        ExtOpStackTable::ext_terminal_constraints(
            ...
            &terminals.op_stack_table_terminals,
        )
    }
}
