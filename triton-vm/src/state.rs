...
impl<'pgm> VMState<'pgm> {
    ...
    fn rescue_xlix_round_constants_by_round_number(
        ...
        const TOTAL_NUM_CONSTANTS: usize = hash_table::NUM_ROUND_CONSTANTS * hash_table::NUM_ROUNDS;
        let round_constants_u64: [u64; TOTAL_NUM_CONSTANTS] = [
        ...
        let round_constants: [BFieldElement; TOTAL_NUM_CONSTANTS] = round_constants_u64
            .iter()
